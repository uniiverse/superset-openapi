  ...
  describe('(package)', function() {
    describe('ReportScheduleRestApiGet', function() {
      ...
      it('should create an instance of ReportScheduleRestApiGet', function() {
        // TODO: update the code to test ReportScheduleRestApiGet
      ...
      it('should have the property lastValueRowJson (base name: "last_value_row_json")', function() {
        // TODO: update the code to test the property lastValueRowJson
        expect(instance).to.have.property('lastValueRowJson');
        // expect(instance.lastValueRowJson).to.be(expectedValueLiteral);
      });
