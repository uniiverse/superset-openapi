...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReportScheduleRestApiGetSlice', function() {
      beforeEach(function() {
        instance = new Superset.ReportScheduleRestApiGetSlice();
      });

      it('should create an instance of ReportScheduleRestApiGetSlice', function() {
        // TODO: update the code to test ReportScheduleRestApiGetSlice
        expect(instance).to.be.a(Superset.ReportScheduleRestApiGetSlice);
      });
