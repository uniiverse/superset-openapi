...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataRestApiPost', function() {
      beforeEach(function() {
        instance = new Superset.ChartDataRestApiPost();
      });

      it('should create an instance of ChartDataRestApiPost', function() {
        // TODO: update the code to test ChartDataRestApiPost
        expect(instance).to.be.a(Superset.ChartDataRestApiPost);
      });
