...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DatabaseConnectionSchema', function() {
      beforeEach(function() {
        instance = new Superset.DatabaseConnectionSchema();
      });

      it('should create an instance of DatabaseConnectionSchema', function() {
        // TODO: update the code to test DatabaseConnectionSchema
        expect(instance).to.be.a(Superset.DatabaseConnectionSchema);
      });
      ...
      it('should have the property parametersSchema (base name: "parameters_schema")', function() {
        // TODO: update the code to test the property parametersSchema
        expect(instance).to.have.property('parametersSchema');
        // expect(instance.parametersSchema).to.be(expectedValueLiteral);
      });
