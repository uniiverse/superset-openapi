...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetOrCreateDatasetSchema', function() {
      beforeEach(function() {
        instance = new Superset.GetOrCreateDatasetSchema();
      });

      it('should create an instance of GetOrCreateDatasetSchema', function() {
        // TODO: update the code to test GetOrCreateDatasetSchema
        expect(instance).to.be.a(Superset.GetOrCreateDatasetSchema);
      });
