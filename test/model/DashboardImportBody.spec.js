...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DashboardImportBody', function() {
      beforeEach(function() {
        instance = new Superset.DashboardImportBody();
      });

      it('should create an instance of DashboardImportBody', function() {
        // TODO: update the code to test DashboardImportBody
        expect(instance).to.be.a(Superset.DashboardImportBody);
      });
