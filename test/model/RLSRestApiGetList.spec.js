...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RLSRestApiGetList', function() {
      beforeEach(function() {
        instance = new Superset.RLSRestApiGetList();
      });

      it('should create an instance of RLSRestApiGetList', function() {
        // TODO: update the code to test RLSRestApiGetList
        expect(instance).to.be.a(Superset.RLSRestApiGetList);
      });
