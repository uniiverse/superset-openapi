  ...
  describe('(package)', function() {
    describe('DatasetRestApiGet', function() {
      ...
      it('should create an instance of DatasetRestApiGet', function() {
        // TODO: update the code to test DatasetRestApiGet
      ...
      it('should have the property createdOnHumanized (base name: "created_on_humanized")', function() {
        // TODO: update the code to test the property createdOnHumanized
        expect(instance).to.have.property('createdOnHumanized');
        // expect(instance.createdOnHumanized).to.be(expectedValueLiteral);
      });
