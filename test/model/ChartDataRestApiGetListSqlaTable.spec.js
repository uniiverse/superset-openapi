...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataRestApiGetListSqlaTable', function() {
      beforeEach(function() {
        instance = new Superset.ChartDataRestApiGetListSqlaTable();
      });

      it('should create an instance of ChartDataRestApiGetListSqlaTable', function() {
        // TODO: update the code to test ChartDataRestApiGetListSqlaTable
        expect(instance).to.be.a(Superset.ChartDataRestApiGetListSqlaTable);
      });
