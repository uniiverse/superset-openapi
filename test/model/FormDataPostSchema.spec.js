...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FormDataPostSchema', function() {
      beforeEach(function() {
        instance = new Superset.FormDataPostSchema();
      });

      it('should create an instance of FormDataPostSchema', function() {
        // TODO: update the code to test FormDataPostSchema
        expect(instance).to.be.a(Superset.FormDataPostSchema);
      });
