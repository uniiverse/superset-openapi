  ...
  describe('(package)', function() {
    describe('DashboardDatasetSchema', function() {
      ...
      it('should create an instance of DashboardDatasetSchema', function() {
        // TODO: update the code to test DashboardDatasetSchema
      ...
      it('should have the property columnTypes (base name: "column_types")', function() {
        // TODO: update the code to test the property columnTypes
        expect(instance).to.have.property('columnTypes');
        // expect(instance.columnTypes).to.be(expectedValueLiteral);
      });
