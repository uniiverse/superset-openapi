...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FilterSetRestApiGet', function() {
      beforeEach(function() {
        instance = new Superset.FilterSetRestApiGet();
      });

      it('should create an instance of FilterSetRestApiGet', function() {
        // TODO: update the code to test FilterSetRestApiGet
        expect(instance).to.be.a(Superset.FilterSetRestApiGet);
      });
