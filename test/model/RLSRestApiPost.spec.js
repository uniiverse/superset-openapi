...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RLSRestApiPost', function() {
      beforeEach(function() {
        instance = new Superset.RLSRestApiPost();
      });

      it('should create an instance of RLSRestApiPost', function() {
        // TODO: update the code to test RLSRestApiPost
        expect(instance).to.be.a(Superset.RLSRestApiPost);
      });
