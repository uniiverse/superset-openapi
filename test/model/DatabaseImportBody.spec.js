...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DatabaseImportBody', function() {
      beforeEach(function() {
        instance = new Superset.DatabaseImportBody();
      });

      it('should create an instance of DatabaseImportBody', function() {
        // TODO: update the code to test DatabaseImportBody
        expect(instance).to.be.a(Superset.DatabaseImportBody);
      });
