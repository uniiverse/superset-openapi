...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataRestApiGetList', function() {
      beforeEach(function() {
        instance = new Superset.ChartDataRestApiGetList();
      });

      it('should create an instance of ChartDataRestApiGetList', function() {
        // TODO: update the code to test ChartDataRestApiGetList
        expect(instance).to.be.a(Superset.ChartDataRestApiGetList);
      });
