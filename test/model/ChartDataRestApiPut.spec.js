...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartDataRestApiPut', function() {
      beforeEach(function() {
        instance = new Superset.ChartDataRestApiPut();
      });

      it('should create an instance of ChartDataRestApiPut', function() {
        // TODO: update the code to test ChartDataRestApiPut
        expect(instance).to.be.a(Superset.ChartDataRestApiPut);
      });
