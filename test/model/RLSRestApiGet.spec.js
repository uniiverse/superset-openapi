...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RLSRestApiGet', function() {
      beforeEach(function() {
        instance = new Superset.RLSRestApiGet();
      });

      it('should create an instance of RLSRestApiGet', function() {
        // TODO: update the code to test RLSRestApiGet
        expect(instance).to.be.a(Superset.RLSRestApiGet);
      });
