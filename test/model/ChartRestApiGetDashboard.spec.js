...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartRestApiGetDashboard', function() {
      beforeEach(function() {
        instance = new Superset.ChartRestApiGetDashboard();
      });

      it('should create an instance of ChartRestApiGetDashboard', function() {
        // TODO: update the code to test ChartRestApiGetDashboard
        expect(instance).to.be.a(Superset.ChartRestApiGetDashboard);
      });
