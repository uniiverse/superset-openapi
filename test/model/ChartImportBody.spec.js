...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ChartImportBody', function() {
      beforeEach(function() {
        instance = new Superset.ChartImportBody();
      });

      it('should create an instance of ChartImportBody', function() {
        // TODO: update the code to test ChartImportBody
        expect(instance).to.be.a(Superset.ChartImportBody);
      });
