...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RecentActivitySchema', function() {
      beforeEach(function() {
        instance = new Superset.RecentActivitySchema();
      });

      it('should create an instance of RecentActivitySchema', function() {
        // TODO: update the code to test RecentActivitySchema
        expect(instance).to.be.a(Superset.RecentActivitySchema);
      });
