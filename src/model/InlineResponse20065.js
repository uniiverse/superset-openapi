...
import {TagRestApiPut} from './TagRestApiPut';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = TagRestApiPut.constructFromObject(data['result']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/TagRestApiPut} result
 */
InlineResponse20065.prototype.result = undefined;
