 ...
 * @version v1
 */
export class DatabaseValidateParametersSchema {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('catalog'))
        obj.catalog = ApiClient.convertToType(data['catalog'], {'String': Object});
 ...
 * @member {Object.<String, Object>} catalog
 */
DatabaseValidateParametersSchema.prototype.catalog = undefined;
 ...
 */
DatabaseValidateParametersSchema.prototype.configurationMethod = undefined;

/**
 * A database name to identify this connection.
 * @member {String} databaseName
 */
DatabaseValidateParametersSchema.prototype.databaseName = undefined;

/**
 * SQLAlchemy driver to use
 * @member {String} driver
 */
DatabaseValidateParametersSchema.prototype.driver = undefined;
 ...
 * @member {Number} id
 */
DatabaseValidateParametersSchema.prototype.id = undefined;
 ...
 */
DatabaseValidateParametersSchema.prototype.impersonateUser = undefined;
 ...
 */
DatabaseValidateParametersSchema.prototype.maskedEncryptedExtra = undefined;
 ...
 */
DatabaseValidateParametersSchema.prototype.serverCert = undefined;
