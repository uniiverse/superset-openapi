...
/**
 * The DatabaseConnectionSchema model module.
 * @module model/DatabaseConnectionSchema
 * @version v1
 */
export class DatabaseConnectionSchema {
  /**
   * Constructs a new <code>DatabaseConnectionSchema</code>.
   * @alias module:model/DatabaseConnectionSchema
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>DatabaseConnectionSchema</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DatabaseConnectionSchema} obj Optional instance to populate.
   * @return {module:model/DatabaseConnectionSchema} The populated <code>DatabaseConnectionSchema</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new DatabaseConnectionSchema();
      ...
      if (data.hasOwnProperty('engine_information'))
        obj.engineInformation = ApiClient.convertToType(data['engine_information'], {'String': Object});
      ...
      if (data.hasOwnProperty('parameters_schema'))
        obj.parametersSchema = ApiClient.convertToType(data['parameters_schema'], {'String': Object});
 ...
 */
DatabaseConnectionSchema.prototype.allowCtas = undefined;

/**
 * Allow CREATE VIEW AS option in SQL Lab
 * @member {Boolean} allowCvas
 */
DatabaseConnectionSchema.prototype.allowCvas = undefined;

/**
 * Allow users to run non-SELECT statements (UPDATE, DELETE, CREATE, ...) in SQL Lab
 * @member {Boolean} allowDml
 */
DatabaseConnectionSchema.prototype.allowDml = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.allowFileUpload = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.allowRunAsync = undefined;

/**
 * SQLAlchemy engine to use
 * @member {String} backend
 */
DatabaseConnectionSchema.prototype.backend = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.cacheTimeout = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.configurationMethod = undefined;

/**
 * A database name to identify this connection.
 * @member {String} databaseName
 */
DatabaseConnectionSchema.prototype.databaseName = undefined;

/**
 * SQLAlchemy driver to use
 * @member {String} driver
 */
DatabaseConnectionSchema.prototype.driver = undefined;

/**
 * @member {Object.<String, Object>} engineInformation
 */
DatabaseConnectionSchema.prototype.engineInformation = undefined;

/**
 * Expose this database to SQLLab
 * @member {Boolean} exposeInSqllab
 */
DatabaseConnectionSchema.prototype.exposeInSqllab = undefined;
 ...
 * @member {String} extra
 */
DatabaseConnectionSchema.prototype.extra = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.forceCtasSchema = undefined;

/**
 * Database ID (for updates)
 * @member {Number} id
 */
DatabaseConnectionSchema.prototype.id = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.impersonateUser = undefined;

/**
 * @member {Boolean} isManagedExternally
 */
DatabaseConnectionSchema.prototype.isManagedExternally = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.maskedEncryptedExtra = undefined;

/**
 * DB-specific parameters for configuration
 * @member {Object.<String, Object>} parameters
 */
DatabaseConnectionSchema.prototype.parameters = undefined;

/**
 * JSONSchema for configuring the database by parameters instead of SQLAlchemy URI
 * @member {Object.<String, Object>} parametersSchema
 */
DatabaseConnectionSchema.prototype.parametersSchema = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.serverCert = undefined;
 ...
 */
DatabaseConnectionSchema.prototype.sqlalchemyUri = undefined;

/**
 * @member {Object} sshTunnel
 */
DatabaseConnectionSchema.prototype.sshTunnel = undefined;

/**
 * @member {String} uuid
 */
DatabaseConnectionSchema.prototype.uuid = undefined;
