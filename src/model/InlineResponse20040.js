 ...
 */
InlineResponse20040.prototype.descriptionColumns = undefined;

/**
 * A list of item ids, useful when you don't know the column id
 * @member {Array.<String>} ids
 */
InlineResponse20040.prototype.ids = undefined;

/**
 * @member {module:model/InlineResponse2001LabelColumns} labelColumns
 */
InlineResponse20040.prototype.labelColumns = undefined;

/**
 * A list of columns
 * @member {Array.<String>} listColumns
 */
InlineResponse20040.prototype.listColumns = undefined;

/**
 * A title to render. Will be translated by babel
 * @member {String} listTitle
 */
InlineResponse20040.prototype.listTitle = undefined;

/**
 * A list of allowed columns to sort
 * @member {Array.<String>} orderColumns
 */
InlineResponse20040.prototype.orderColumns = undefined;
