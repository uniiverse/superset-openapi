...
import {DatasetDuplicateSchema} from './DatasetDuplicateSchema';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = DatasetDuplicateSchema.constructFromObject(data['result']);
    }
    return obj;
  }
}
...
/**
 * @member {module:model/DatasetDuplicateSchema} result
 */
InlineResponse20110.prototype.result = undefined;
