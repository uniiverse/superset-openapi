...
import {TagRestApiGet} from './TagRestApiGet';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = TagRestApiGet.constructFromObject(data['result']);
 ...
 */
InlineResponse20064.prototype.descriptionColumns = undefined;

/**
 * The item id
 * @member {String} id
 */
InlineResponse20064.prototype.id = undefined;

/**
 * @member {module:model/InlineResponse2001LabelColumns} labelColumns
 */
InlineResponse20064.prototype.labelColumns = undefined;

/**
 * @member {module:model/TagRestApiGet} result
 */
InlineResponse20064.prototype.result = undefined;

/**
 * A list of columns
 * @member {Array.<String>} showColumns
 */
InlineResponse20064.prototype.showColumns = undefined;

/**
 * A title to render. Will be translated by babel
 * @member {String} showTitle
 */
InlineResponse20064.prototype.showTitle = undefined;
