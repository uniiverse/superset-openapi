...
import {DatabaseTablesResponse} from './DatabaseTablesResponse';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('result'))
        obj.result = ApiClient.convertToType(data['result'], [DatabaseTablesResponse]);
    }
    return obj;
  }
}
 ...
 * @member {Array.<module:model/DatabaseTablesResponse>} result
 */
