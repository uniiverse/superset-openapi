...
/**
 * The RLSRestApiPut model module.
 * @module model/RLSRestApiPut
 * @version v1
 */
export class RLSRestApiPut {
  /**
   * Constructs a new <code>RLSRestApiPut</code>.
   * @alias module:model/RLSRestApiPut
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>RLSRestApiPut</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RLSRestApiPut} obj Optional instance to populate.
   * @return {module:model/RLSRestApiPut} The populated <code>RLSRestApiPut</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RLSRestApiPut();
 ...
 */
RLSRestApiPut.prototype.clause = undefined;

/**
 * Detailed description
 * @member {String} description
 */
RLSRestApiPut.prototype.description = undefined;
 ...
 * @member {module:model/RLSRestApiPut.FilterTypeEnum} filterType
 */
RLSRestApiPut.prototype.filterType = undefined;
 ...
 */
RLSRestApiPut.prototype.groupKey = undefined;

/**
 * Name of rls filter
 * @member {String} name
 */
RLSRestApiPut.prototype.name = undefined;
 ...
 */
RLSRestApiPut.prototype.roles = undefined;

/**
 * These are the tables this filter will be applied to.
 * @member {Array.<Number>} tables
 */
RLSRestApiPut.prototype.tables = undefined;
