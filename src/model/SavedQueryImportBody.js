...
/**
 * The SavedQueryImportBody model module.
 * @module model/SavedQueryImportBody
 * @version v1
 */
export class SavedQueryImportBody {
  /**
   * Constructs a new <code>SavedQueryImportBody</code>.
   * @alias module:model/SavedQueryImportBody
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>SavedQueryImportBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SavedQueryImportBody} obj Optional instance to populate.
   * @return {module:model/SavedQueryImportBody} The populated <code>SavedQueryImportBody</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new SavedQueryImportBody();
 ...
 */
SavedQueryImportBody.prototype.formData = undefined;

/**
 * overwrite existing saved queries?
 * @member {Boolean} overwrite
 */
SavedQueryImportBody.prototype.overwrite = undefined;
 ...
 */
SavedQueryImportBody.prototype.passwords = undefined;
 ...
 */
SavedQueryImportBody.prototype.sshTunnelPasswords = undefined;
 ...
 */
SavedQueryImportBody.prototype.sshTunnelPrivateKeyPasswords = undefined;
 ...
 */
SavedQueryImportBody.prototype.sshTunnelPrivateKeys = undefined;
