 ...
 */
InlineResponse20010.prototype.descriptionColumns = undefined;

/**
 * A list of item ids, useful when you don't know the column id
 * @member {Array.<String>} ids
 */
InlineResponse20010.prototype.ids = undefined;

/**
 * @member {module:model/InlineResponse2001LabelColumns} labelColumns
 */
InlineResponse20010.prototype.labelColumns = undefined;

/**
 * A list of columns
 * @member {Array.<String>} listColumns
 */
InlineResponse20010.prototype.listColumns = undefined;

/**
 * A title to render. Will be translated by babel
 * @member {String} listTitle
 */
InlineResponse20010.prototype.listTitle = undefined;

/**
 * A list of allowed columns to sort
 * @member {Array.<String>} orderColumns
 */
InlineResponse20010.prototype.orderColumns = undefined;
