...
/**
    ...
    * @enum {string}
    */
export declare enum ChartDataExtrasRelativeEndEnum {
    Today = "today",
    Now = "now"
}
/**
    ...
    * @enum {string}
    */
export declare enum ChartDataExtrasRelativeStartEnum {
    Today = "today",
    Now = "now"
}
/**
    ...
    * @enum {string}
    */
export declare enum ChartDataExtrasTimeGrainSqlaEnum {
    PT1S = "PT1S",
    PT5S = "PT5S",
    PT30S = "PT30S",
    PT1M = "PT1M",
